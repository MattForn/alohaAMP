...
class InsertionTask(BimanualViperXTask):
    ...
    def get_reward(self, physics):
        ...
        peg_touch_right_gripper_right_finger = ("red_peg", "vx300s_right/10_right_gripper_finger") in all_contact_pairs
        peg_touch_right_gripper_left_finger = ("red_peg", "vx300s_right/10_left_gripper_finger") in all_contact_pairs
        
        
        socket_touch_left_gripper_left_finger = (
            ("socket-1", "vx300s_left/10_left_gripper_finger") in all_contact_pairs
            or ("socket-2", "vx300s_left/10_left_gripper_finger") in all_contact_pairs
            or ("socket-3", "vx300s_left/10_left_gripper_finger") in all_contact_pairs
            or ("socket-4", "vx300s_left/10_left_gripper_finger") in all_contact_pairs
        )
        socket_touch_left_gripper_right_finger = (
            ("socket-1", "vx300s_left/10_right_gripper_finger") in all_contact_pairs
            or ("socket-2", "vx300s_left/10_right_gripper_finger") in all_contact_pairs
            or ("socket-3", "vx300s_left/10_right_gripper_finger") in all_contact_pairs
            or ("socket-4", "vx300s_left/10_right_gripper_finger") in all_contact_pairs
        )
        ...
        reward = 0
        if peg_touch_right_gripper_right_finger:
            reward += 0.25
        if peg_touch_right_gripper_left_finger:  
            reward += 0.25
        if socket_touch_left_gripper_left_finger:
            reward += 0.25
        if socket_touch_left_gripper_right_finger:
            reward += 0.25
        if peg_touch_right_gripper_left_finger    and not peg_touch_table:  # lifted
            reward += 0.25
        if peg_touch_right_gripper_right_finger   and not peg_touch_table:  # lifted
            reward += 0.25
        if socket_touch_left_gripper_left_finger  and not socket_touch_table:  # lifted
            reward += 0.25
        if socket_touch_left_gripper_right_finger and not socket_touch_table:  # lifted
            reward += 0.25
